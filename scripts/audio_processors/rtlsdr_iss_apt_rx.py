...
## This is currently a clone of rtlsdr_noaa_apt_rx.py with NOAA renamed to ISS
...
class rtlsdr_iss_apt_rx(gr.top_block):
...
def main(top_block_cls=rtlsdr_iss_apt_rx, options=None):
