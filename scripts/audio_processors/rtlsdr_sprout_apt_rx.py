...
# Title: RTLSDR ISS APT Receiver V1.0.0
# Author: 
# Description: APT to WAV recorder for Raspberry-Noaa -V2
# Generated: 
##################################################

## This is currently a clone of rtlsdr_noaa_apt_rx.py with NOAA renamed to SPROUT
...
class rtlsdr_sprout_apt_rx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "RTLSDR ISS APT Receiver V1.0.0")
...
def main(top_block_cls=rtlsdr_sprout_apt_rx, options=None):
